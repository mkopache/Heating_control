/*
	...
	Modified by MEK 3/20/18 by removing enum already defined in another ModbusRTU package
	   This version must be used in conjunction with ModbusRTU.h
*/
...
//  changed by MEK to avoid clash with modbusRtu.h 
enum xMB_FC {
  xMB_FC_NONE           = 0,
  xMB_FC_READ_COILS     = 1,
  xMB_FC_READ_REGISTERS = 3,
  xMB_FC_WRITE_COIL     = 5,
  xMB_FC_WRITE_REGISTER = 6,
  //Function codes 15 & 16 by Martin Pettersson http://siamect.com
  xMB_FC_WRITE_MULTIPLE_COILS = 15,
  xMB_FC_WRITE_MULTIPLE_REGISTERS = 16
};
