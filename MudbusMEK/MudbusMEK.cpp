...
{  
  ...
  if(FC == xMB_FC_READ_COILS)
  {
    ...
    #ifdef MbDebug
      Serial.print(" xMB_FC_READ_COILS S=");
      Serial.print(Start);
      Serial.print(" L=");
  ...
  //****************** Read Registers ******************
  if(FC == xMB_FC_READ_REGISTERS)
  {
    Start = word(ByteArray[8],ByteArray[9]);
    WordDataLength = word(ByteArray[10],ByteArray[11]);
    ByteDataLength = WordDataLength * 2;
    #ifdef MbDebug
      Serial.print(" xMB_FC_READ_REGISTERS S=");
      Serial.print(Start);
      Serial.print(" L=");
  ...
  //****************** Write Coil **********************
  if(FC == xMB_FC_WRITE_COIL)
  {
    Start = word(ByteArray[8],ByteArray[9]);
    C[Start] = word(ByteArray[10],ByteArray[11]) > 0;
    #ifdef MbDebug
      Serial.print(" xMB_FC_WRITE_COIL C");
      Serial.print(Start);
      Serial.print("=");
  ...
  //****************** Write Register ******************
  if(FC == xMB_FC_WRITE_REGISTER)
  {
    Start = word(ByteArray[8],ByteArray[9]);
    R[Start] = word(ByteArray[10],ByteArray[11]);
    #ifdef MbDebug
      Serial.print(" xMB_FC_WRITE_REGISTER R");
      Serial.print(Start);
      Serial.print("=");
  ...
  if(FC == xMB_FC_WRITE_MULTIPLE_COILS)
  {
    Start = word(ByteArray[8],ByteArray[9]);
    CoilDataLength = word(ByteArray[10],ByteArray[11]);
    ByteDataLength = CoilDataLength / 8;
    ...
    CoilDataLength = ByteDataLength * 8;
    #ifdef MbDebug
      Serial.print(" xMB_FC_WRITE_MULTIPLE_COILS S=");
      Serial.print(Start);
      Serial.print(" L=");
      Serial.println(CoilDataLength);
    #endif
  ...
  //Function codes 15 & 16 by Martin Pettersson http://siamect.com
  if(FC == xMB_FC_WRITE_MULTIPLE_REGISTERS)
  {
    Start = word(ByteArray[8],ByteArray[9]);
    WordDataLength = word(ByteArray[10],ByteArray[11]);
    ByteDataLength = WordDataLength * 2;
...
{
  if(fc == 1) FC = xMB_FC_READ_COILS;
  if(fc == 3) FC = xMB_FC_READ_REGISTERS;
  if(fc == 5) FC = xMB_FC_WRITE_COIL;
  if(fc == 6) FC = xMB_FC_WRITE_REGISTER;
  if(fc == 15) FC = xMB_FC_WRITE_MULTIPLE_COILS;
  if(fc == 16) FC = xMB_FC_WRITE_MULTIPLE_REGISTERS;
}
